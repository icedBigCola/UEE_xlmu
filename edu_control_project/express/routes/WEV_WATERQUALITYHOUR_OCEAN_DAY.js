...
var WEV_WATERQUALITYHOUR_OCEAN_DAY = require('../sequelize/WEV_WATERQUALITYHOUR_OCEAN_DAY')
...
//查询素有用户信息接口
router.get('/all_quality_ocean',async(req,res,next)=>{
  try{
    await WEV_WATERQUALITYHOUR_OCEAN_DAY.findAll().then(function(rives){
